...
* **AC5** An SMS notification should be sent to the owner when the listing of the property becomes available.
* **AC6** The notification must include the property identification and the date it became available.
* **AC7** The Notification must include the name and phone number of the responsible Agent.
...
* List of comissions.
* An SMS notification to the owner
