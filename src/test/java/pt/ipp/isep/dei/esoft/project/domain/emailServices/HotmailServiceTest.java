...
public class HotmailServiceTest {
    ...
    public void testSendEmail() {
        ...
        // Act
        hotmailService.sendEmail(expectedEmail, expectedSubject, expectedBody);

        // Assert
        try (BufferedReader reader = new BufferedReader(new FileReader("HotmailNotification.txt"))) {
            String line;
